...
st.dataframe(pandas.pivot_table(filtered_frame, values='claim_id', index=['store_name', 'courier_name'], columns=['is_final', 'type'], aggfunc=lambda x: len(x.unique()), fill_value=0))
